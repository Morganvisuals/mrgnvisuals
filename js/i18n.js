...
(function () {
  ...
  const dict = {
    fr: {
      ...
      'pcard.24.desc': "Dossier structurant mon parcours : objectifs, compétences, aides, budget et plan d'action.",
    ...
    en: {
      ...
      'pcard.24.desc': "A report structuring my career path: goals, skills, support, budget and action plan.",
